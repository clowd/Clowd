...
impl SimpleText {
    ...
    pub fn add_run<'a>(
        ...
        self.add_var_run(scene, font, size, &[], brush, transform, glyph_transform, style, text);
    }
    ...
    pub fn add(&mut self, scene: &mut Scene, font: Option<&Font>, size: f32, brush: Option<&Brush>, transform: Affine, text: &str) {
