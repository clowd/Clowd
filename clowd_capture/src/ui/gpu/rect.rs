...
/// selects one of four shader modes (checked in this order):
///
/// | predicate                              | mode |
/// |----------------------------------------|------|
...
/// SDF edge lands on the intended rect; the rounded modes need it so
/// their AA fringe has room to fade.
#[repr(C)]
