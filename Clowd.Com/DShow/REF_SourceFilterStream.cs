...
namespace Clowd.Com
{
                    ...
                    , IAMBufferNegotiation
    {
        ...
        public override int SetMediaType(AMMediaType mt)
        {
            ...
            return (m_Filter as VideoCaptureFilter).SetMediaType(mt);
        }

        public override int CheckMediaType(AMMediaType pmt)
        {
            return (m_Filter as VideoCaptureFilter).CheckMediaType(pmt);
        }

        public override int GetMediaType(int iPosition, ref AMMediaType pMediaType)
        {
            return (m_Filter as VideoCaptureFilter).GetMediaType(iPosition, ref pMediaType);
        }
        ...
        public override int DecideBufferSize(ref IMemAllocatorImpl pAlloc, ref AllocatorProperties pProperties)
        {
            ...
            return (m_Filter as VideoCaptureFilter).DecideBufferSize(ref pAlloc, ref pProperties);
        }
        ...
        public override int FillBuffer(ref IMediaSampleImpl _sample)
        {
            ...
            do
            {
                ...
                hr = (HRESULT)(m_Filter as VideoCaptureFilter).FillBuffer(ref _sample);
        ...
        public int SuggestAllocatorProperties(AllocatorProperties pprop)
        {
            ...
            HRESULT hr = (HRESULT)(m_Filter as VideoCaptureFilter).SuggestAllocatorProperties(pprop);
            if (FAILED(hr))
            {
                m_pProperties = null;
                return hr;
            ...
            if (m_pProperties == null)
            {
                ...
                (m_Filter as VideoCaptureFilter).GetAllocatorProperties(m_pProperties);
            }
        ...
        public int GetAllocatorProperties(AllocatorProperties pprop)
        {
            ...
            return (m_Filter as VideoCaptureFilter).GetAllocatorProperties(pprop);
        }
        ...
        public int SetFormat(AMMediaType pmt)
        {
            ...
            if (IsConnected)
            {
                ...
                if (SUCCEEDED(hr))
                {
                    ...
                    if (SUCCEEDED(hr))
                    {
                        hr = (HRESULT)(m_Filter as VideoCaptureFilter).SetMediaType(_newType);
                    }
                    else
                    {
                        m_mt.Set(_oldType);
        ...
        public int GetNumberOfCapabilities(IntPtr piCount, IntPtr piSize)
        {
            int iCount;
            int iSize;
            HRESULT hr = (HRESULT)(m_Filter as VideoCaptureFilter).GetNumberOfCapabilities(out iCount, out iSize);
            if (hr.Failed) return hr;
        ...
        public int GetStreamCaps(int iIndex, IntPtr ppmt, IntPtr pSCC)
        {
            ...
            HRESULT hr = (HRESULT)(m_Filter as VideoCaptureFilter).GetStreamCaps(iIndex, out pmt, out _caps);
        ...
        {
            return (m_Filter as VideoCaptureFilter).GetLatency(out prtLatency);
        }
