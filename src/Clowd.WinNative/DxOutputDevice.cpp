...
void DxOutputDevice::BeginDraw(ID2D1DeviceContext** dc)
{
    if (drawing)
...
void DxOutputDevice::CreateFontFormat(DxRef<IDWriteTextFormat>& format, FLOAT fontSizePt, bool bold, bool monospaced)
{
