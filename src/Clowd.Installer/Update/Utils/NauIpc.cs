...
namespace NAppUpdate.Framework.Utils
{
    ...
    internal static class NauIpc
    {
        ...
        internal static string ExtractUpdaterFromResource(string updaterPath)
        {
            ...
            //foreach (var refr in myAssy.GetReferencedAssemblies())
            //{
            //    var refName = Path.GetFileName(refr.)
            //}
