...
namespace Clowd.Drawing.Graphics
{
    ...
    public class GraphicCount : GraphicText
    {
        ...
        protected override void DrawObjectImpl(DrawingContext context, bool showText)
        {
            ...
            if (showText)
            {
                // decision #32: WPF centered the text on the origin X via TextAlignment.Center; in Avalonia we
                // draw at (centerX − width/2, centerY − height/2) and keep TextAlignment.Center for multi-line.
                var form = CreateFormattedText();
                form.TextAlignment = TextAlignment.Center;
                context.DrawText(form, new Point(center.X - (form.Width / 2), center.Y - (form.Height / 2)));
            }
        }
