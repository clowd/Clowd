...
using FLOAT = System.Single;
#else
#error Unknown vector type -- must define one of AVALONIA_VECTOR, SYSTEM_WINDOWS_VECTOR, SYSTEM_NUMERICS_VECTOR, or UNITY
#endif
...
namespace Clowd.Drawing.Curves
{
    ...
    /// System.Numerics.Vector2, UnityEngine.Vector2, Avalonia.Vector, or another vector type.
    /// </summary>
    public static class VectorHelper
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public static FLOAT DistanceSquared(VECTOR a, VECTOR b) { var dx = a.X - b.X; var dy = a.Y - b.Y; return dx * dx + dy * dy; }
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public static FLOAT Dot(VECTOR a, VECTOR b) { return a.X * b.X + a.Y * b.Y; }
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public static VECTOR Normalize(VECTOR v) { var len = v.Length; return len > 0 ? new VECTOR(v.X / len, v.Y / len) : v; }
