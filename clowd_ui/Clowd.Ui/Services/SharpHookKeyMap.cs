...
/// <summary>
/// Translates Avalonia <see cref="AvKey"/>/<see cref="AvMods"/> to the SharpHook native equivalents
/// so hotkeys defined in settings can be matched against live <see cref="KeyboardHookEventArgs"/>.
/// </summary>
internal static class SharpHookKeyMap
{
    ...
    public static KeyCode? TryMapKey(AvKey key) => key switch
    {
        ...
        AvKey.PrintScreen => KeyCode.VcPrintScreen,
