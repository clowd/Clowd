...
import { DefaultZoomMenuContent, TldrawUiButton, TldrawUiMenuContextProvider, useMenuIsOpen, useTranslation } from 'tldraw'

export interface TLUiZoomMenuProps {
    children?: ReactNode
}

export const CustomZoomMenu = memo(function DefaultZoomMenu({ children }: TLUiZoomMenuProps) {
    ...
    function ZoomTriggerButton(props, ref) {
        ...
        return (
            <TldrawUiButton
                ...
                className={'tlui-zoom-menu__button__pct'}
