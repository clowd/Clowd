...
namespace PropertyTools.Wpf
{
    ...
    public class DefaultPropertyItemFactory : IPropertyItemFactory
    {
        ...
        {
            var pi = this.CreateCore(instance, pd, propertyDescriptors);
        ...
        /// A property item.
        /// </returns>
        protected virtual PropertyItem CreateCore(object instance, PropertyDescriptor pd, PropertyDescriptorCollection propertyDescriptors)
        {
            return new PropertyItem(instance, pd, propertyDescriptors);
        }
