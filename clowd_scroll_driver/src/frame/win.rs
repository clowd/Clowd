...
//!   which is the one thing [`crate::frame`] promises it will not do.
...
/// Capture `rect`. Dimensions are already known to be positive — the shared
/// wrapper in [`crate::frame`] rejects a degenerate rect before this runs.
